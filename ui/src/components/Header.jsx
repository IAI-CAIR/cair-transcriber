...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      >
        <img src="https://upload.wikimedia.org/wikipedia/en/thumb/9/99/Dev_Sanskriti_Vishwavidyalaya.jpg/250px-Dev_Sanskriti_Vishwavidyalaya.jpg" width={70} alt="Logo of Indic Subtitler" />
